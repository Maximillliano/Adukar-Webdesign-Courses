...
Философия и погружение в UX/UI
...
Определение опыта и навыков дизайнеров
...
Анализ состояния проектов и CV
...
Командная работа и субординация
...
Выделение целевой аудитории и подготовительный анализ
...
Проект-фриланс. Wireframe и prototype
...
Проект-фриланс. UI элементы и сдача проекта
Создание Guideline
...
Мобильная игра. Wireframe и prototype
...
Мобильная игра. Интерактивный прототип и презентация
...
Программа курса 23 занятий: https:

Расписанная программа курсов через Github с ссылками на материалы с актуальным изменениями: https://github.com/

Добавлены новые презентации, полностью все переделанные, дополненные и подстроенные под формат занятия с учетом отзывов учеников, старых наработок и отзывов преподавателей: https://drive.google.com

По программе курсов Веб-дизайн модуль: https://docs.google.com/document/d/18SZQ5TsL88SIAZJ6t4QqgzCZaiptRekq/edit# 
